      ...
      <View style={{ flex: 1 }}>
        <View style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'column', gap: 16 }}>
              ...
              <View style={{ width: 50, height: 71, position: 'relative' }}>
                <View style={{ width: 50, height: 45.80, left: 0, top: 25.20, position: 'absolute' }}>
                  ...
                  <View style={{ width: 20, height: 22, left: 16.50, top: 11.60, position: 'absolute', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                    <TextInput style={{ color: '#BCC5CB', fontSize: 14, fontWeight: '400', justifyContent: 'center' }} placeholder='00'/>
                  </View>
                </View>
                  <Text style={{ width: 50, left: 0, top: 0, position: 'absolute', color: 'black', fontSize: 16, fontWeight: '400', lineHeight: 16 }}>Jour</Text>
              </View>
            </View>
            ...
            <View style={{ width: '15%'}}>
              <View style={{ width: 50, height: 71, position: 'relative' }}>
                <View style={{ width: 50, height: 45.80, left: 0, top: 25.20, position: 'absolute' }}>
                  ...
                  <Text style={{ width: 50, left: 0, top: 0, position: 'absolute', color: 'black', fontSize: 16, fontWeight: '400', lineHeight: 16 }}>Mois</Text>
              </View>
            </View>
              ...
              <View style={{ width: 50, height: 71, position: 'relative' }}>
                <View style={{ width: 50, height: 45.80, top: 25.20, position: 'absolute' }}>
                  ...
                  <View style={{ width: 80, height: 22, top: 11.60, position: 'absolute', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                    <TextInput style={{ color: '#BCC5CB', fontSize: 14, fontWeight: '400', justifyContent: 'center' }} placeholder='0000'/>
                  </View>
                </View>
                  <Text style={{ width: 80,  position: 'absolute', color: 'black', fontSize: 16, fontWeight: '400', lineHeight: 16 }}>Année</Text>
              </View>
            </View>
            ...
            <View style={{ width: '20%'}}>
              <View style={{ width: 50, height: 71, position: 'relative' }}>
                <View style={{ width: 50, height: 45.80, top: 25.20, position: 'absolute' }}>
                  <View style={{ width: 80, height: 45.80, left: 0, top: 0, position: 'absolute', backgroundColor: 'white', borderRadius: 12, borderWidth: 1, borderColor: '#CDD4D8' }} />
                  <View style={{ width: 80, height: 22, top: 11.60, position: 'absolute', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                    <TextInput style={{ color: '#BCC5CB', fontSize: 14, fontWeight: '400', justifyContent: 'center'}} placeholder='00:00'/>
                  </View>
                </View>
                  <Text style={{ width: 80,  position: 'absolute', color: 'black', fontSize: 16, fontWeight: '400', lineHeight: 16 }}>Heure</Text>
              </View>
            </View>
          </View>
          
          <Text style={{ color: 'black', fontSize: 16, fontWeight: '700', lineHeight: 25 }}>Lieu</Text>
          <View style={{ width: 358, height: 64, position: 'relative', marginBottom: 16}}>
            ...
            <TextInput style={{ width: 358, height: 46, backgroundColor: 'white', borderRadius: 12, borderWidth: 1, borderColor: '#CDD4D8', paddingLeft: 12, color: '#BCC5CB', fontSize: 14, fontWeight: '400', lineHeight: 18 }} placeholder="Rentrez le lieu de l'accident" />
          </View>          

          <Text style={{ color: 'black', fontSize: 16, fontWeight: '700', lineHeight: 18 }}>Type de véhicule</Text>
          <View style={{ width: 358, height: 64, position: 'relative', marginBottom: 16}}>
            <Text style={{ width: 358, height: 16, left: 0, top: 48, position: 'absolute', textAlign: 'right', color: 'black', fontSize: 12, fontWeight: '400', lineHeight: 16, marginTop : 8}}>0/100</Text>
            <TextInput style={{ width: 358, height: 46, backgroundColor: 'white', borderRadius: 12, borderWidth: 1, borderColor: '#CDD4D8', paddingLeft: 12, color: '#BCC5CB', fontSize: 14, fontWeight: '400', lineHeight: 18 }}  placeholder="Décrivez les différents véhicules impliqués" />
          </View>

          <Text style={{ color: 'black', fontSize: 16, fontWeight: '700', lineHeight: 18 }}>Type de collision</Text>
          <View style={{ width: 358, height: 64, position: 'relative', marginBottom: 16}}>
            <Text style={{ width: 358, height: 16, left: 0, top: 48, position: 'absolute', textAlign: 'right', color: 'black', fontSize: 12, fontWeight: '400', lineHeight: 16, marginTop : 8}}>0/100</Text>
            <TextInput style={{ width: 358, height: 46, backgroundColor: 'white', borderRadius: 12, borderWidth: 1, borderColor: '#CDD4D8', paddingLeft: 12, color: '#BCC5CB', fontSize: 14, fontWeight: '400', lineHeight: 18 }}  placeholder="Expliquer le type de colision" />
          </View>
          ...
          <View style={{ width: 358, height: 64, position: 'relative' }}>
            <Text style={{ width: 358, height: 16, left: 0, top: 48, position: 'absolute', textAlign: 'right', color: 'black', fontSize: 12, fontWeight: '400', lineHeight: 16, marginTop : 8}}>0/100</Text>
            <TextInput style={{ width: 358, height: 46, backgroundColor: 'white', borderRadius: 12, borderWidth: 1, borderColor: '#CDD4D8', paddingLeft: 12, color: '#BCC5CB', fontSize: 14, fontWeight: '400', lineHeight: 18 }}  placeholder="Ajouter un commentaire" />
          </View>
