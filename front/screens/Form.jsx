    ...
    <View style={{ flex: 1, backgroundColor: 'white', paddingHorizontal: '5%', paddingTop: '20%' }}>
      <View style={{ flex: 1 }}>
        <View style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'column', gap: 16 }}>
          <View style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'row', gap: 16 }}>
          ...
          <View style={{ width: 358, height: 64, position: 'relative', marginBottom: 10}}>
            <Text style={{ width: 358, height: 16, left: 0, top: 48, position: 'absolute', textAlign: 'right', color: 'black', fontSize: 12, fontFamily: 'Marianne', fontWeight: '400', lineHeight: 16 }}>0/100</Text>
          ...
          <Text style={{ marginTop: 10, color: 'black', fontSize: 16, fontFamily: 'Marianne', fontWeight: '700', lineHeight: 25 }}>Commentaire</Text>
          ...
          <TouchableOpacity style={{ alignSelf: 'stretch', padding: 10, justifyContent: 'center', alignItems: 'center', backgroundColor: '#4B7BEC', borderRadius: 10 }}>
